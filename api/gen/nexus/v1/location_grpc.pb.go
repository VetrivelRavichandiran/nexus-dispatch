...
const (
	LocationService_UpdateLocation_FullMethodName      = "/nexus.v1.LocationService/UpdateLocation"
	LocationService_BatchUpdateLocation_FullMethodName = "/nexus.v1.LocationService/BatchUpdateLocation"
)
...
type LocationServiceClient interface {
	...
	BatchUpdateLocation(ctx context.Context, in *BatchUpdateLocationRequest, opts ...grpc.CallOption) (*BatchUpdateLocationResponse, error)
}
...
func (c *locationServiceClient) BatchUpdateLocation(ctx context.Context, in *BatchUpdateLocationRequest, opts ...grpc.CallOption) (*BatchUpdateLocationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchUpdateLocationResponse)
	err := c.cc.Invoke(ctx, LocationService_BatchUpdateLocation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LocationServiceServer interface {
	...
	// BatchUpdateLocation is used by the simulator for high-throughput ingest.
	BatchUpdateLocation(context.Context, *BatchUpdateLocationRequest) (*BatchUpdateLocationResponse, error)
...
func (UnimplementedLocationServiceServer) BatchUpdateLocation(context.Context, *BatchUpdateLocationRequest) (*BatchUpdateLocationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchUpdateLocation not implemented")
}
...
func _LocationService_BatchUpdateLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchUpdateLocationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocationServiceServer).BatchUpdateLocation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LocationService_BatchUpdateLocation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServiceServer).BatchUpdateLocation(ctx, req.(*BatchUpdateLocationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LocationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nexus.v1.LocationService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchUpdateLocation",
			Handler:    _LocationService_BatchUpdateLocation_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "nexus/v1/location.proto",
}
